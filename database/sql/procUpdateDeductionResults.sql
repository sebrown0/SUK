...
BEGIN
	INSERT INTO `salaroo_uk`.`payroll_result_deduction`(
		...
		`employee_payroll_details_payroll_id`, `paye_tax`, `ni`, `pension`, `total`)
	VALUES
		(prRunId, prRunTaxYearId, prPayrollFrequencyId, employeeId, payeTax, empNi, empPension, totalDeduction)
