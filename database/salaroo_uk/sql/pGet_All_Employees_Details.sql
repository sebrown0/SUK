CREATE DEFINER=`root`@`localhost` PROCEDURE `get_all_employees_details`()
BEGIN
	SELECT 
        ...
        hr.employee_hours_normally_worked, hr.martial_status, hr.ni_number, hr.start_date, hr.starting_declaration,
